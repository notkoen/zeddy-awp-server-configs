...
#define MAX_PLAYER_SPAWNS 64

float g_fTSpawnPoints[MAX_PLAYER_SPAWNS][2][3];
float g_fCTSpawnPoints[MAX_PLAYER_SPAWNS][2][3];

int g_iTSpawnPointsCount = 0;
int g_iCTSpawnPointsCount = 0;